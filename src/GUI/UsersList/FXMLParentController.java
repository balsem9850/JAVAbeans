...
public class FXMLParentController implements Initializable {
    ...
    @FXML
    private Button planingrendezvous;
    @FXML
    ...
    @FXML
    private void toPlaning(ActionEvent event) throws IOException {
           tfparent.getChildren().clear();
        Pane newLoadedPane =        FXMLLoader.load(getClass().getResource("/GUI/UsersList/gestionplaninig.fxml"));
        tfparent.getChildren().add(newLoadedPane); 
    }
    ...
    private void ToRDV(ActionEvent event) throws IOException {
            tfparent.getChildren().clear();
        Pane newLoadedPane =        FXMLLoader.load(getClass().getResource("/GUI/UsersList/FXMLrendezvous.fxml"));
        tfparent.getChildren().add(newLoadedPane); 
    }
    ...
    private void Acceuil(ActionEvent event) throws IOException {
         tfparent.getChildren().clear();
        Pane newLoadedPane =        FXMLLoader.load(getClass().getResource("/GUI/upserve1/Acceuil.fxml"));
        tfparent.getChildren().add(newLoadedPane); 
    }
