...
public class MailerAPI {
    ...
    public static void mailingValider(String recipient, int nombre) throws Exception {
        ...
        final String moncompteEmail = "noreply.learn4u@gmail.com";
        final String psw = "123456sss";
        ...
        try {
            ...
            msg.setText("Thank you for using Learn4u , Here is your confitmation code :   " + String.valueOf(nombre));
